//Wap to count no. of whitespaces and newline
#include <stdio.h>
...
//Wap to find if string is constant or not
#include<stdio.h>
#include<string.h>
#include<ctype.h>
int main(){
...
//Wap to find if string is keyword or not
#include<stdio.h>
#include<string.h>
int main(){
...
//Wap to find if string is identifier or not
#include<stdio.h>
#include<string.h>
#include<ctype.h>
int main(){
